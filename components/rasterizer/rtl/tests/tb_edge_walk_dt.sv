...
module tb_edge_walk_dt;
    ...
    initial begin
        ...
        $readmemh("../components/rasterizer/rtl/tests/vectors/edge_walk_stim.hex", stim_mem);
        $readmemh("../components/rasterizer/rtl/tests/vectors/edge_walk_exp.hex", exp_mem);
        ...
        $readmemh("../components/rasterizer/rtl/tests/vectors/edge_walk_hiz_stim.hex", stim_mem);
        $readmemh("../components/rasterizer/rtl/tests/vectors/edge_walk_hiz_exp.hex", exp_mem);
