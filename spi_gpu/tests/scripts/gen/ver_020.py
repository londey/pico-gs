...
def generate() -> list[str]:
    ...
    lines.append(emit_comment("Textured quad with 256x256 BC4-compressed Skyline (grayscale)."))
    ...
    # TEX0_CFG: ENABLE=1, NEAREST, BC4 (format 3), 256x256, REPEAT, 0 mips
    tex_cfg = pack_tex0_cfg(1, 0, 3, 8, 8, 0, 0, 0, TEX_SLOT_0_512)
