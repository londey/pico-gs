...
def generate() -> list[str]:
    ...
    lines.append(emit_comment("Textured quad with 256x256 BC1-compressed Skyline texture."))
    ...
    # TEX0_CFG: ENABLE=1, NEAREST, BC1 (format 0), 256x256, REPEAT, 0 mips
    tex_cfg = pack_tex0_cfg(1, 0, 0, 8, 8, 0, 0, 0, TEX_SLOT_0_512)
    ...
    # Quad as two triangles covering most of the 64x64 framebuffer.
