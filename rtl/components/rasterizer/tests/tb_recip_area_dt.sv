...
module tb_recip_area_dt;
    ...
    initial begin
        $readmemh("../rtl/components/rasterizer/tests/vectors/recip_area_stim.hex", stim_mem);
        $readmemh("../rtl/components/rasterizer/tests/vectors/recip_area_exp.hex", exp_mem);
