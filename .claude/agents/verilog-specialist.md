...
3. The corresponding digital twin crate (`components/<name>/twin/`) — understand the bit-accurate algorithm before writing RTL

## Responsibilities

- Implement and modify SystemVerilog modules under `components/*/rtl/src/`
...
- Create or update `.hex` stimulus files in `components/<name>/rtl/tests/`
