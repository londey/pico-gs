...
- **Golden image approval:** Per `test_strategy.md`, run the simulation, visually inspect the output PNG, copy it to `integration/golden/ver_014_textured_cube.png`, and commit.
