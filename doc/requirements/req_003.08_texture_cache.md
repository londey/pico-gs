...
Implementation details (associativity, replacement policy, XOR set indexing, pseudo-LRU replacement, EBR usage) are documented in UNIT-011.03 (L1 Decompressed Cache) and UNIT-011.05 (L2 Compressed Cache).
