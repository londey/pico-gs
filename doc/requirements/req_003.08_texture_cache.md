...
When texels are stored in the cache, the system SHALL store them in UQ1.8 per channel format (36 bits per texel) regardless of the source texture format (BC1–BC4, RGB565, RGBA8888, or R8), so that cache reads are format-independent.
