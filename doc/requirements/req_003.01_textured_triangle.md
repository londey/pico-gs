...
- **VER-005** (texture_decoder_tb) — Verilator unit test for the texture decoder module.
  Drives the decoder with known SDRAM-format tile data and verifies that decoded UQ1.8 output matches expected pixel values.
...
Acceptance criteria (verified jointly by VER-005 and VER-012; supplementally by VER-014):
