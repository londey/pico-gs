...
|----------|--------|------------|
| EBR (9kb blocks) | ≤39 of 56 (70%) | 32 texture cache (16 per sampler × 2 samplers) + 1 dither matrix + 2 color grade LUT (double-buffered) + 1 scanline FIFO + 1 SPI receive FIFO + 1 triangle setup reciprocal (`raster_recip_area.sv`, DP16KD 36×512) + 1 per-pixel 1/Q reciprocal (`raster_recip_q.sv`, DP16KD 18×1024) |
| DSP slices (18x18) | ≤16 of 28 (57%) | 8 MULT18X18D in UNIT-005 (rasterizer): 2 for edge C-coefficient computation and sequential derivative inv_area scaling (time-shared, DD-036), 1 for triangle setup reciprocal interpolation, 1 for per-pixel 1/Q reciprocal interpolation, 4 for per-pixel perspective correction (S×1/Q and T×1/Q for two texture units); 4–6 MULT18X18D in UNIT-010 (Color Combiner) for Q4.12 multiply-accumulate, Gouraud shade, and alpha blend; total 12–14 of 16 budget |
