...
| DSP slices (18x18) | ≤16 of 28 (57%) | 8 MULT18X18D in UNIT-005 (rasterizer): 2 for edge C-coefficient computation, 1 for triangle setup reciprocal interpolation, 1 for per-pixel 1/Q reciprocal interpolation, 4 for per-pixel perspective correction (S×1/Q and T×1/Q for two texture units); 4–6 MULT18X18D in UNIT-010 (Color Combiner) for Q4.12 multiply-accumulate, Gouraud shade, and alpha blend; total 12–14 of 16 budget |
...
UNIT-005 uses 8 MULT18X18D: 2 for edge C-coefficient setup, 1 for triangle setup reciprocal interpolation (`raster_recip_area.sv`), 1 for per-pixel 1/Q reciprocal interpolation (`raster_recip_q.sv`), and 4 dedicated multipliers for per-pixel perspective correction (U×(1/Q) and V×(1/Q) for sampler 0 and sampler 1).
