...
- UNIT-005 (Rasterizer) — DSP slices for reciprocal LUT interpolation and per-pixel perspective correction
- UNIT-006 (Pixel Pipeline) — texture decoder muxing LUT cost; EBR for texture caches
- UNIT-007 (Memory Arbiter)
- UNIT-009 (DVI TMDS Encoder)
- UNIT-010 (Color Combiner) — DSP slices for Q4.12 fixed-point multiply-accumulate
...
| DSP slices (18x18) | ≤16 of 28 (57%) | 7 MULT18X18D in UNIT-005 (rasterizer): 2 for edge C-coefficient computation, 1 for reciprocal LUT linear interpolation, 4 for per-pixel perspective correction (S×1/Q and T×1/Q for two texture units); 4–6 MULT18X18D in UNIT-010 (Color Combiner) for Q4.12 multiply-accumulate, Gouraud shade, and alpha blend; total 11–13 of 16 budget |
...
UNIT-005 uses 7 MULT18X18D: 2 for edge C-coefficient setup, 1 for reciprocal LUT linear interpolation (shared for both inv_area and per-pixel 1/Q computation), and 4 dedicated multipliers for per-pixel perspective correction (U×(1/Q) and V×(1/Q) for sampler 0 and sampler 1).
UNIT-010 (Color Combiner) requires 4–6 DSP slices for Q4.12 multiply-accumulate blend equations (REQ-004.02).
Combined rasterizer and combiner DSP usage of 11–13 slices remains within the ≤16 budget, leaving 3–5 slices of margin.
