...
Framebuffer registers (FB_DRAW, FB_DISPLAY) may be configured autonomously by the FPGA boot sequence (REQ-001.04) via pre-populated command FIFO entries, prior to any host SPI communication.
