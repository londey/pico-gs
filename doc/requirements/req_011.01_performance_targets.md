...
- UNIT-005 (Rasterizer) — primary triangle throughput and fragment evaluation rate
- UNIT-006 (Pixel Pipeline) — texture fetch, blending, and framebuffer write throughput
- UNIT-007 (SRAM Arbiter) — memory bandwidth and SDRAM access efficiency
- UNIT-008 (Display Controller) — pixel clock and scanout timing
