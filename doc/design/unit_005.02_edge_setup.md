...
- `rtl/components/rasterizer/src/rasterizer.sv`: Edge setup logic within the parent rasterizer module.
...
- `rtl/components/rasterizer/src/raster_recip_area.sv`: Dedicated triangle setup reciprocal module — 1 DP16KD (36×512), CLZ normalization on signed 22-bit magnitude, UQ4.14 output, optional Newton-Raphson refinement.
