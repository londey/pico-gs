...
- `rtl/components/display/src/tmds_encoder.sv`: TMDS 8b/10b encoder (one instance per channel)
- `rtl/components/display/src/dvi_output.sv`: Top-level DVI output with 3 encoder instances and serialization
