...
The pixel clock is derived as clk_core / 4 (synchronous integer divider from the unified 100 MHz GPU/SRAM clock), giving a synchronous 4:1 relationship between the GPU core domain and the pixel domain.
