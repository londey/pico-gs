...
- `components/texture/rtl/texture_cache.sv`: UV wrap logic is implemented as combinational logic within the texture cache module; see the `uv_wrap_*` and `mip_sel` sections
