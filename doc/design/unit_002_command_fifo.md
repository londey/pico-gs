...
- `rtl/rtl/components/utils/src/async_fifo.sv`: Custom soft FIFO with synthesis-time memory initialization (replaces previous Lattice EBR FIFO macro)
- `rtl/components/spi/src/command_fifo.sv`: Wrapper/instantiation with boot sequence parameters
