...
mod scripts {
    ...
    pub const VER_010: &str = include_str!("../../scripts/ver_010_gouraud.hex");

    /// VER-011: Depth-tested overlapping triangles.
    pub const VER_011: &str = include_str!("../../scripts/ver_011_depth_test.hex");

    /// VER-012: Textured triangle.
    pub const VER_012: &str = include_str!("../../scripts/ver_012_textured.hex");

    /// VER-013: Color-combined triangle.
    pub const VER_013: &str = include_str!("../../scripts/ver_013_color_combined.hex");

    /// VER-014: Textured cube.
    pub const VER_014: &str = include_str!("../../scripts/ver_014_textured_cube.hex");

    /// VER-015: Triangle size grid.
    pub const VER_015: &str = include_str!("../../scripts/ver_015_size_grid.hex");
